      ...
      >
        ...
        >
          ...
          <div className="d-flex align-items-start">
            <img
              className="me-2"
              src="/dashboard/assets/img/icons/paragraph.svg"
              width="20"
              alt=""
            />
            <div className="flex-1">
              ...
              <p className="fs--1 mb-2">
                Select a suitable navigation system htmlFor your web application{" "}
              </p>
              <div>
          ...
          <p className="fs--1 mb-0">
            Switch between styles htmlFor your vertical navbar{" "}
          </p>
          <p>
            {" "}
            <a
